...
def sweep_chain(cname, c):
    ...
    ruln = (dep.get("sendUln302") or {}).get("address")
...
with ThreadPoolExecutor(max_workers=7) as ex:
    ...
    for fut in as_completed(futs):
        ...
        json.dump(out, open("/tmp/opencode/ulncfg_send_events.json", "w"), indent=1)
print(f"\ndone {done}/13; saved /tmp/opencode/ulncfg_send_events.json")
