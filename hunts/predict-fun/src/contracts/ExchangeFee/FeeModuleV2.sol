...
import {CalculatorHelperV2} from "./libraries/CalculatorHelperV2.sol";

/// @title CTF Fee Module V2
/// @notice Proxies the CTFExchange contract and refunds orders
contract FeeModuleV2 is IFeeModuleV2, Auth, Transfers, ERC1155TokenReceiver {
    ...
    function _calculateTakerRefund(
        ...
        return
            CalculatorHelperV2.calculateRefund(
                order.feeRateBps,
                feeAmount,
    ...
    function _calculateMakerRefund(
        ...
        uint256 takingAmount = CalculatorHelperV2.calculateTakingAmount(
            fillAmount,
            order.makerAmount,
            order.takerAmount
        );
