...
library CalculatorHelperV3 {
    uint256 internal constant ONE = 10 ** 18;

    uint256 internal constant BPS_DIVISOR = 10_000;

    /**
     * @notice Error thrown when the operator fee amount is greater than the exchange fee amount
     */
    error OperatorFeeAmountGreaterThanExchangeFeeAmount();
    ...
    function calculateRefund(
        ...
        if (exchangeFeeAmount < operatorFeeAmount) {
            revert OperatorFeeAmountGreaterThanExchangeFeeAmount();
        }
