...
library Helpers {
    ...
    function positionIds(address _collateral, bytes32 _conditionId) internal view returns (uint256[] memory) {
        ...
        // YES
        positionIds_[0] = CTHelpers.getPositionId(IERC20(_collateral), CTHelpers.getCollectionId(bytes32(0), _conditionId, 1));
        // NO
        positionIds_[1] = CTHelpers.getPositionId(IERC20(_collateral), CTHelpers.getCollectionId(bytes32(0), _conditionId, 2));
