...
interface INegRiskAdapterEE is IMarketStateManagerEE, IAuthEE {
    ...
    event IsSplitPositionGatedUpdated(bool gated);

    /// @dev Emitted when the isMergePositionsGated flag is toggled.
    event IsMergePositionsGatedUpdated(bool gated);

    /// @dev Emitted when the isConvertPositionsGated flag is toggled.
    event IsConvertPositionsGatedUpdated(bool gated);

    /**
     * @dev Emitted when the permissions for a user are set.
     * @param user The address of the user
     * @param canSplitPosition True if the user can split positions
     * @param canMergePositions True if the user can merge positions
     * @param canConvertPositions True if the user can convert positions
     */
    event PermissionsUpdated(
        address indexed user,
        bool canSplitPosition,
        bool canMergePositions,
        bool canConvertPositions
    );
    ...
    /**
     * @notice Permissions struct for a user
     * @param canSplitPosition True if the user can split positions
     * @param canMergePositions True if the user can merge positions
     * @param canConvertPositions True if the user can convert positions
     */
