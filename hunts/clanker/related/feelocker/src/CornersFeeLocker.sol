...
import {ICornersFeeLocker} from "./interfaces/ICornersFeeLocker.sol";
...
contract CornersFeeLocker is ICornersFeeLocker, ReentrancyGuard, Ownable {
    ...
    function supportsInterface(bytes4 interfaceId) external pure returns (bool) {
        return interfaceId == type(ICornersFeeLocker).interfaceId;
    }
}
